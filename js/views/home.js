views.home = function(){
	...
	<div class="row">
		<div class="col-md-9">
			<h3>Dear Citizens,</h3>
				...
				<ul>
					...
					<li>Meditate</li>
					<li>Read <a href="https://www.goodreads.com/book/show/10210.Jane_Eyre" target="_blank">a novel</a> once in a while for christs sake</li>
					<li>Eat less meat and processed sugar</li>
					<li>Experience nature</li>
					<li>Dont be so grouchy</li>
				</ul>
		...
		<div class="col-md-3">
			<img class="img-responsive impossible" src="img/impossible.png" alt="impossible figure"/>
		</div>
	</div><!-- end row -->
